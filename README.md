...
| **[Decisions](https://alexsendula.github.io/freya-devkit/decisions.html)** | The sixteen ADRs, and what each one rejected |
...
- [`decisions/`](docs/decisions/) — sixteen ADRs: what was decided, why, and what was rejected
