...
graph metadata as a degradation with the reason (`graph_ops.py:3461`). The check binds the call
...
(`graph_ops.py:2773`). It is pinned by a test that fails under mutation of that branch.
