...
> `knowledge-base/BACKLOG.md` by full overwrite (`collect_status.py:349`), and on a
...
operator — once in the census line (`collect_status.py:293`) and again as the coverage-gap
section header (`collect_status.py:330`) — with 33 of the 57 permanently unactionable. That is
