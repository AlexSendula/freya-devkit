/* ============================================================================
   freya-devkit — explainer site: shared shell (nav, footer, theme, TOC spy).
...
(function () {
  ...
  var PAGES = [
    ...
    { href: "using.html",        label: "Using it" },
    { href: "how-it-works.html", label: "How it works" },
    { href: "extending.html",    label: "Extending it" },
    { href: "reference.html",    label: "Reference" },
    { href: "decisions.html",    label: "Decisions" },
    { href: "evolution.html",    label: "How it evolved" }
  ];

  var REPO = "https://github.com/AlexSendula/freya-devkit";
  ...
  function buildFooter() {
    ...
    host.innerHTML =
      '<footer class="site-footer"><div class="footer-inner">' +
        '<div>An explainer for <strong>freya-devkit</strong> — ten composable skills that keep ' +
        'your dependency graph, docs, specs, behaviors and security posture in sync, on any ' +
        'coding agent that runs skills. Reference material lives in the repo.</div>' +
        '<div class="footer-links">' + links +
          '<a href="' + REPO + '">Source · github.com/AlexSendula/freya-devkit</a>' +
        "</div>" +
      "</div></footer>";
  }
  ...
  function buildTOC() {
    ...
    heads.forEach(function (h) {
      ...
      // hidden from assistive tech, so it must be out of the tab order too
