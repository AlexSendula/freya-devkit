...
- `freya-spec-manager adr create <name>` — interactive authoring command
- `freya-spec-manager adr verify` — deterministic integrity check
- `freya-spec-manager adr list` — print / regenerate the ADR index
